...
<body>
	...
	<div id="wrapper">
		<div id="logo"></div>
		<div id="title"><img src="/img/openStat.svg"><span style="font-size: 0.8rem">openStat-Instanz</span></div>	
		<div id="title_after"></div>
		<div id="actionneeded">
			<?php 
				if ( isset($_SESSION['e']) AND $_GET['e'] == "noextension" ) { ?>
					<p>Bitte aktiviere die <b>openCRM</b>-Erweiterung für Firefox.</p>
				...
				if ( isset($_SESSION['e']) AND $_GET['e'] == "extensionupdate" ) { ?>
					<p>Bitte aktualisiere die <b>openCRM</b>-Erweiterung für Firefox:</p>
					<p><a href="https://addons.mozilla.org/addon/openstat/">https://addons.mozilla.org/addon/openstat/</a></p>
					<p>und <b>erlaube die Aktivierung der Erweiterung in privaten Fenstern</b>.</p>
				<?php };
				if ( isset($_SESSION['e']) AND $_GET['e'] == "notprivate" ) { ?>
					Bitte öffne <b>openCRM</b> in einem privaten Fenster (Strg+Umschalt+P).
				<?php };
			 ?>
		</div>
		<div id="error">
